...
if __name__ == "__main__":
    ...
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_student.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_employee.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_incoming_request.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_vote.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_protocol.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_vote_students.sql")
    )
    db_engine.execute_and_commit(
        statement=get_script_from_file(script_name="functions/create_function_add_vote_employees.sql")
    )
